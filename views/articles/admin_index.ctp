<div class="articles index">
	...
	<tr class="sortHeader">
		...
		<th><?php echo $this->Paginator->sort(__('lang', true), 'Article.lang');?></th>
		<th><?php echo $this->Paginator->sort(__('title', true), 'Article.title');?></th>
		<th><?php echo $this->Paginator->sort(__('introtext', true), 'Article.introtext');?></th>
		<th><?php echo $this->Paginator->sort(__('fulltext', true), 'Article.fulltext');?></th>
	...
	<tr class="searchHeader">
		<td></td>
			<td>
			<?php
				echo $this->AlaxosForm->filter_field('lang');
			?>
		</td>
		<td>
			<?php
		...
		<td>
			<?php
				echo $this->AlaxosForm->filter_field('introtext');
			?>
		</td>
		<td>
			<?php
				echo $this->AlaxosForm->filter_field('fulltext');
			?>
		</td>
		<td>
			<?php
