<div class="prixlegumes index">
	...
	<tr class="sortHeader">
		...
		<th><?php __('Prix moyen PER');?></th>
		<th><?php __('Prix moyen BIO');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo ($prixlegume['Prixlegume']['prixminPER']+$prixlegume['Prixlegume']['prixmaxPER'])/2; ?>
		</td>
		<td>
			<?php echo ($prixlegume['Prixlegume']['prixminBIO']+$prixlegume['Prixlegume']['prixmaxBIO'])/2; ?>
		</td>
		<td>
